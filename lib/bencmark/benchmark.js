...
var Benchmark = /** @class */ (function () {
    ...
    Benchmark.plotAndSaveMeasurementTimesCharts = function (pathToMeasurementsPng) {
        ...
        var canvas = Benchmark.generateGraph(loopNumbers, timesToGeneration);
        var buffer = canvas.toBuffer('image/png');
        if (!(0, fs_1.existsSync)(pathToMeasurementsPng)) {
            (0, fs_1.mkdirSync)(pathToMeasurementsPng);
        }
        (0, fs_1.writeFileSync)("".concat(pathToMeasurementsPng, "/measurements.png"), buffer);
    };
    ...
    Benchmark.generateGraph = function (loopIndices, timeToGeneration) {
